...
- **Regional band plans** — 27 bundled plans with 1,771 validated entries, searchable country/region names and independent A/B selection. [Inmarsat plans](bandplans/SATELLITES.md) cover I4A, 4F2, 3F5, 4F3 and 6F1, plus historical 4F1. Selecting a satellite plan tunes to channel groups that fit the receiver bandwidth; individual frequencies are selectable. See [the catalogue](bandplans/CATALOGUE.md) for coverage and dated survey limitations; this is not every country worldwide.
